...
const ActiveItems = () => {
  ...
  return (<div className="p-6 h-screen bg-gray-50 dark:bg-gray-900 transition-all">
    <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Your Active Items</h1>

    <table className="min-w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg shadow-md overflow-hidden transition-all">
      <thead>
