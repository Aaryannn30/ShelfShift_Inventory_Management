...
const SaleOrder = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b dark:bg-[#030637]">
      {/* Header */}
      <header className="bg-white m-5 dark:bg-[#17153B] border shadow-md flex justify-between items-center p-6 rounded-b-lg">
        <div className="relative">
          {/* Dropdown Button */}
          <button
            onClick={() => setDropdownOpen(!dropdownOpen)}
            className="text-lg font-bold text-blue-700 dark:text-blue-300 bg-blue-600 px-5 py-2 rounded-lg flex items-center"
          >
            All Sales Orders
          ...
          {/* Dropdown Menu */}
          {dropdownOpen && (
            <div className="absolute left-0 mt-2 w-56 bg-white dark:bg-[#17153B] border rounded-lg shadow-md z-10">
              {["All", "Draft", "Pending Approval", "Approved", "Confirmed", "For Packaging", "To be Shipped", "Shipped", "On Hold", "New Custom View"].map((status) => (
                <Link to="#" key={status}>
                  <div className="block px-4 py-2 text-blue-700 dark:text-blue-300 hover:bg-gray-100 transition">
                    {status}
                  </div>
                </Link>
              ))}
      ...
      {/* Main Content */}
      <main className="flex-1 p-8 m-5 bg-white dark:bg-[#17153B] border rounded-lg shadow-lg mt-6">
        <h2 className="text-3xl font-bold text-center text-blue-700 dark:text-blue-300 mb-4">
        ...
        <section className="mt-10">
          <h3 className="text-center text-xl font-semibold  text-blue-700 dark:text-blue-300 mb-4">
            Life Cycle of a Sales Order
          </h3>
