...
const Packages = () => {
  ...
  return (
    <div className="flex flex-col h-screen p-6 dark:bg-[#030637]">
      {/* Header */}
      <header className="bg-white shadow-lg p-4 flex justify-between items-center border dark:bg-[#17153B]">
        <div className="flex items-center ">
          <i className="fas fa-bars text-gray-600 mr-4"></i>
          <h1 className="text-2xl font-bold text-blue-600 ">All Packages</h1>
        </div>
